    ...
    <main style={{ minHeight: '100vh', background: '#F7F7F7' }}>
      ...
      <div style={{ maxWidth: 720, margin: '0 auto', padding: '64px 6%' }}>
        <div style={{ marginBottom: 48, paddingBottom: 40, borderBottom: '1px solid #E5E7EB' }}>
          ...
          <h1 style={{ fontSize: 'clamp(28px, 4vw, 44px)', fontWeight: 900, letterSpacing: -1.2, lineHeight: 1.05, color: '#111', marginBottom: 12 }}>
            List your startup
          </h1>
          <p style={{ fontSize: 15, color: '#4B5563', lineHeight: 1.6 }}>
            Tell people what you're building and who you're looking for.
          </p>
        </div>
        ...
        <div style={{ background: '#fff', border: '1px solid #E5E7EB', marginBottom: 1 }}>
          ...
          <div style={{ padding: '28px', display: 'flex', flexDirection: 'column', gap: 24 }}>
            <div>
              ...
              <input name="name" value={form.name} onChange={handleChange} placeholder="e.g. Foundo" style={inputStyle}
                onFocus={e => (e.target.style.borderColor = '#E84A00')} onBlur={e => (e.target.style.borderColor = '#E5E7EB')} />
            </div>
            <div>
              <label style={labelStyle}>Tagline *</label>
              <input name="tagline" value={form.tagline} onChange={handleChange} placeholder="One line that says what you do" style={inputStyle}
                onFocus={e => (e.target.style.borderColor = '#E84A00')} onBlur={e => (e.target.style.borderColor = '#E5E7EB')} />
            </div>
